...
if (isset($_GET['tanggal'])) {
    $sqlEdit = mysqli_query($connect, "select * from alatae where Tanggal='$_GET[tanggal]'");
    $i = 0;
...
<head>
    <title>Form Pemeliharaan Peralatan AE</title>
...
?><script>
        ...
        <form action="data-pemeliharaan.php" method="post">
            ...
            <table class="table">
                ...
                <tbody>
                    <?php
$namaperalatan = array('PC KAPOKSI AEROLOGI','PC STAF AEROLOGI','PC STAF AEROLOGI','HUB','UPS 3 KVA','UPS 2 KVA','UPS 1 KVA','PRINTER','STAVOLT');
$merksn = array('SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK');
...
?>
            ...
            <input type="hidden" name="namaalat" value="alatae">
