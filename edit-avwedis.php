...
if (isset($_GET['tanggal'])) {
    $sqlEdit = mysqli_query($connect, "select * from avwedis where Tanggal='$_GET[tanggal]'");
    $i = 0;
...
<head>
  <title>Form Pemeliharaan AV Wedis</title>
...
?><script>
    ...
    <div class="form-group"><label for="ti">Nama :</label><input type="text"
      ...
      <table class="table">
        ...
        <tbody>
        <?php
$namaperalatan = array('SERVER AERO-WEATHER UTAMA','SERVER VISUAL-WEATHER UTAMA','SERVER AERO-WEATHER BACK-UP','SERVER VISUAL-WEATHER BACK-UP');
$merksn = array('TEKNOLOGI CANGGIH/MODERN','TEKNOLOGI CANGGIH/MODERN','TEKNOLOGI CANGGIH/MODERN','TEKNOLOGI CANGGIH/MODERN');
...
?>
      ...
      <div class="form-group"><label for="ti">Catatan Khusus : </label><textarea
          ...
          <input type="hidden" name="namaalat" value="avwedis">
