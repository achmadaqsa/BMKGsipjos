...
if (isset($_GET['tanggal'])) {
    $sqlEdit = mysqli_query($connect, "select * from alatob where Tanggal='$_GET[tanggal]'");
    $i = 0;
...
<head>
  <title>Form Pemeliharaan OB</title>
...
?><script>
     ...
     <form action="data-pemeliharaan.php" method="post">
        ...
        <tbody>
        <?php
$namaperalatan = array('PC KAPOKSI OBSERVASI','PC OPERASIONAL OBSERVASI','PC OPERASIONAL KOMUNIKASI','PC STAF OBSERVASI','PC STAF KOMUNIKASI','PC BMKGSOFT','UPS 5 KVA','UPS 3 KVA','PRINTER','ROUTER','HUB 16 PORT','HUB 8 PORT','RADIOLINK OBS-SERVER','MESIN FINGERPRINT');
$merksn = array('SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK');
...
?>
            ...
            <input type="hidden" name="namaalat" value="alatob">
