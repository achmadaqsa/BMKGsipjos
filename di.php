...
if(isset($_GET['tanggal'])){
    ...
    $query=mysqli_query($connect, "(SELECT * FROM alatdi WHERE Tanggal='$tanggal') ORDER by Tanggal ASC");
    $i=0;
...
//if($_POST['tp']=="") header("Location: pemeliharaan-alatdi.php");
if (isset($_POST['simpan']) && ($_POST['tp'] != "") && ($_POST['np'] != "")) {
    ...
    for ($i = 0; $i < $max; $i++) {
        ...
        $merk[$i] = $_POST["merk$i"];
        mysqli_query($connect, "INSERT INTO alatdi VALUES ('','$tanggal','$alat[$i]','$merk[$i]','$kondisi[$i]','$nama','$catatan')");
    }
}
...
$pdf->Cell(133, 5, ': '.$tanggal, 0, 1, 'L');

$pdf->SetFont('Arial','', 10);
$pdf->Cell(20,5,'Unit Kerja',0,0, 'L');
$pdf->Cell(40,5, ': DATA INFORMASI',0,0, 'L');

$pdf->MultiCell(0,5,'', 0, 2);
$pdf->SetFont('Arial','', 10);
$pdf->Cell(20,5, 'Teknisi',0,0, 'L');
$pdf->Cell(133, 5, ': '.$nama, 0, 1, 'L');
...
$pdf->Cell(30,5,'PC KASI DATIN','LRT',0,'L');
...
$pdf->Cell(25,5,'R. KASI DATIN',1,0,'C');
$pdf->Cell(0,5,'',1,0,'C');
...
$pdf->Cell(30,5,'PC BULETIN','LRT',0,'L');
$pdf->Cell(40,5,'SEDERHANA ELEKTRONIK',1,0,'C');
$pdf->Cell(10,5,'1 UNIT',1,0,'C');
if($kondisi[7]==0){
    $pdf->Cell(20,5,'X',1,0,'C');
...
$pdf->MultiCell(0,5,'');
$pdf->Cell(7,10,'9',1,0,'C');
$pdf->Cell(30,10,'PC PELAYANAN','LRT',0,'L');
...
$pdf->Cell(25,5,'R. PELAYANAN','LR',0,'C');
$pdf->Cell(0,10,'',1,0,'C');
...
$pdf->MultiCell(0,5,'');
$pdf->Cell(7,5,'1',1,0,'C');
$pdf->Cell(30,5,'HUB 8 PORT','LRT',0,'L');
$pdf->Cell(40,5,'SEDERHANA ELEKTRONIK',1,0,'C');
$pdf->Cell(10,5,'1 UNIT',1,0,'C');
if($kondisi[9]==0){
    $pdf->Cell(20,5,'X',1,0,'C');
...
//----------------------------------------------------------------------------------
//Keterangan
$pdf->Cell(0,20,'',0,1);// Memberikan space kebawah agar tidak terlalu rapat
