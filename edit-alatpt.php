...
if (isset($_GET['tanggal'])) {
    $sqlEdit = mysqli_query($connect, "select * from alatpt where Tanggal='$_GET[tanggal]'");
    $i = 0;
...
<head>
  <title>Form Pemeliharaan Peralatan PT</title>
...
?><script>
 ...
 <form action="data-pemeliharaan.php" method="post">
        ...
        <tbody>
        <?php
$namaperalatan = array('PC STAF PERTEK','PC STAF PERTEK','PC STAF PERTEK','PC STAF PERTEK','CLOUD SHARING','HUB 8 PORT','HUB 5 PORT','UPS 2 KVA','UPS 1 KVA','PRINTER-SCANNER');
$merksn = array('SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK');
...
?>
            ...
            <input type="hidden" name="namaalat" value="alatpt">
