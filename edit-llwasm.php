...
if (isset($_GET['tanggal'])) {
    $sqlEdit = mysqli_query($connect, "select * from llwasm where Tanggal='$_GET[tanggal]'");
    $i = 0;
...
<head>
  <title>Form Pemeliharaan LLWASM</title>
...
?><script>
     ...
     <form action="data-pemeliharaan.php" method="post">
        ...
        <tbody>
        <?php
$namaperalatan = array('Server ims0','Server ims1','PC Client Observer','PC Client Forecaster','PC Client Teknisi','PC Client ATC','PC Client APP');
$merksn = array('Fujitsu','Fujitsu','Fujitsu','Fujitsu','Fujitsu','Fujitsu','Fujitsu');
...
?>
      ...
      <div class="form-group"><label for="ti">Catatan Khusus : </label><textarea
          ...
          <input type="hidden" name="namaalat" value="llwasm">
