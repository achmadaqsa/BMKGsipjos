...
if (isset($_GET['tanggal'])) {
    $sqlEdit = mysqli_query($connect, "select * from alatsv where Tanggal='$_GET[tanggal]'");
    $i = 0;
...
<head>
  <title>Form Pemeliharaan Server</title>
...
?><script>
     ...
     <form action="data-pemeliharaan.php" method="post">
        ...
        <tbody>
        <?php
$namaperalatan = array('PC SERVER WEBSITE','PC SERVER FLIGHDOC','ROUTER MIKROTIK','SWITCH HUB 16 PORT','ANTENA RADIOLINK','MODEM FIBER OPTIC','UPS');
$merksn = array('SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK');
...
?>
            ...
            <input type="hidden" name="namaalat" value="alatsv">
