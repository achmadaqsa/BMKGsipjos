...
if(isset($_GET['tanggal'])){
    ...
    $query=mysqli_query($connect, "(SELECT * FROM alatsv WHERE Tanggal='$tanggal') ORDER by Tanggal ASC");
    $i=0;
...
//if($_POST['tp']=="") header("Location: pemeliharaan-alatsv.php");
if (isset($_POST['simpan']) && ($_POST['tp'] != "") && ($_POST['np'] != "")) {
    ...
    for ($i = 0; $i < $max; $i++) {
        ...
        $merk[$i] = $_POST["merk$i"];
        mysqli_query($connect, "INSERT INTO alatsv VALUES ('','$tanggal','$alat[$i]','$merk[$i]','$kondisi[$i]','$nama','$catatan')");
    }
}
...
$pdf->Cell(40,5, ': RUANG TEKNISI',0,0, 'L');
...
$pdf->Cell(30,5,'PC SERVER','LRT',0,'L');
...
$pdf->Cell(25,10,'R. SERVER',1,0,'C');
$pdf->Cell(0,10,'',1,0,'C');

$pdf->MultiCell(0,5,'');
$pdf->Cell(7,5,'',0,0,'C');
$pdf->Cell(30,5,'WEBSITE','LRB',0,'L');
...
$pdf->MultiCell(0,5,'');
$pdf->Cell(7,5,'',0,0,'C');
$pdf->Cell(30,5,'FLIGHDOC','LRB',0,'L');
...
$pdf->Cell(30,5,'ROUTER MIKROTIK','LRT',0,'L');
...
$pdf->Cell(25,5,'R. SERVER',1,0,'C');
$pdf->Cell(0,5,'',1,0,'C');

$pdf->MultiCell(0,5,'');
$pdf->Cell(7,10,'2',1,0,'C');
$pdf->Cell(30,5,'SWITCH HUB 16','LRT',0,'L');
$pdf->Cell(40,10,'SEDERHANA ELEKTRONIK',1,0,'C');
$pdf->Cell(10,10,'2 UNIT',1,0,'C');
if($kondisi[3]==0){
    $pdf->Cell(20,10,'X',1,0,'C');
...
$pdf->MultiCell(0,5,'');
$pdf->Cell(7,5,'',0,0,'C');
$pdf->Cell(30,5,'PORT','LRB',0,'L');

$pdf->MultiCell(0,5,'');
$pdf->Cell(7,5,'3',1,0,'C');
$pdf->Cell(30,5,'ANTENA RADIOLINK','LRT',0,'L');
$pdf->Cell(40,5,'SEDERHANA ELEKTRONIK',1,0,'C');
$pdf->Cell(10,5,'2 UNIT',1,0,'C');
if($kondisi[4]==0){
    $pdf->Cell(20,5,'X',1,0,'C');
...
$pdf->Cell(30,5,'MODEM FIBER','LRT',0,'L');
$pdf->Cell(40,10,'SEDERHANA ELEKTRONIK',1,0,'C');
$pdf->Cell(10,10,'3 UNIT',1,0,'C');
if($kondisi[5]==0){
    $pdf->Cell(20,10,'X',1,0,'C');
}
if($kondisi[5]==1){
