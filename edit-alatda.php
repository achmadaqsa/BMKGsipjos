...
if (isset($_GET['tanggal'])) {
    $sqlEdit = mysqli_query($connect, "select * from alatda where Tanggal='$_GET[tanggal]'");
    $i = 0;
...
<head>
  <title>Form Pemeliharaan DA</title>
...
?><script>
 ...
 <form action="data-pemeliharaan.php" method="post">
        ...
        <tbody>
        <?php
$namaperalatan = array('Antena RF Receiver','Antena GPS','Reapeter Antena GPS','Receiver','Sonde Checker','PC Pengolahan Radiosonde & Pibal','Theodolit Pibal');
$merksn = array('MEISEI / RD-06G-001 / 04891','SANAV / SA-200 / 0005371','MEISEI / RD-06G-005 / 04911','MEISEI / - / 537411','MEISEI / - / 53762','DELL / OPTIPLEX 3046','BREITHAUPT KASSEL / - / 463930');
...
?>
      ...
      <div class="form-group"><label for="ti">Catatan Khusus : </label><textarea
          ...
          <input type="hidden" name="namaalat" value="alatda">
