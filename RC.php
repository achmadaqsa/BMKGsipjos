...
if(isset($_GET['tanggal'])){
    ...
    $query=mysqli_query($connect, "(SELECT * FROM `radarcuaca` WHERE Tanggal='$tanggal') ORDER by Tanggal ASC");
    $i=0;
...
//if($_POST['tp']=="") header("Location: pemeliharaan-radarcuaca.php");
if (isset($_POST['simpan']) && ($_POST['tp'] != "") && ($_POST['np'] != "")) {
    ...
    for ($i =0; $i < $max; $i++) {
        ...
        $merk[$i] = $_POST["merk$i"];
        mysqli_query($connect, "INSERT INTO radarcuaca VALUES ('','$tanggal','$alat[$i]','$merk[$i]','$kondisi[$i]','$nama','$catatan')");
    }
}
...
$pdf->SetFont('Arial', 'B', 12);
$pdf->Cell(180, 5, 'Radar Cuaca', 0, 1, 'C');
//----------------------------------------------------------------------------------
//identitas
...
$pdf->Cell(133, 5, ':Gedung Radar Cuaca/Stasiun Meteorologi Kelas I Juanda Sidoarjo', 'LR', 1, 'L');
...
$pdf->SetFont('Arial', 'B', 10);
$pdf->Cell(0, 5, 'II. Kondisi Komponen Radar Cuaca', 0, 1);
$pdf->SetFont('Arial', 'B', 8);
...
$pdf->Cell(40, 5, 'DEHYDRATOR', 1, 0, 'L');
$pdf->Cell(55, 5, 'GEMATRONIK', 1, 0, 'C');
if ($kondisi[0] == 0) {
...
$pdf->Cell(40, 5, 'ANTENNA & PEDESTAL', 1, 0, 'L');
$pdf->Cell(55, 5, 'GEMATRONIK', 1, 0, 'C');
if ($kondisi[1] == 0) {
    $pdf->Cell(9, 5, 'V', 1, 0, 'C');
    $pdf->Cell(9, 5, '', 1, 0, 'C');
...
$pdf->Cell(40, 5, 'BLOK CABINET FAN', 1, 0, 'L');
$pdf->Cell(55, 5, 'GEMATRONIK', 1, 0, 'C');
if ($kondisi[2] == 0) {
    $pdf->Cell(9, 5, 'V', 1, 0, 'C');
    $pdf->Cell(9, 5, '', 1, 0, 'C');
...
$pdf->Cell(40, 5, 'DBLOK MAGNETRON', 1, 0, 'L');
$pdf->Cell(55, 5, 'GEMATRONIK', 1, 0, 'C');
if ($kondisi[3] == 0) {
    $pdf->Cell(9, 5, 'V', 1, 0, 'C');
    $pdf->Cell(9, 5, '', 1, 0, 'C');
...
$pdf->Cell(40, 5, 'ANTENNA CONTROL UNIT', 1, 0, 'L');
$pdf->Cell(55, 5, 'GEMATRONIK', 1, 0, 'C');
if ($kondisi[4] == 0) {
    $pdf->Cell(9, 5, 'V', 1, 0, 'C');
    $pdf->Cell(9, 5, '', 1, 0, 'C');
...
$pdf->Cell(40, 5, 'DBLOK TRANSMITTER', 1, 0, 'L');
$pdf->Cell(55, 5, 'GEMATRONIK', 1, 0, 'C');
if ($kondisi[5] == 0) {
    $pdf->Cell(9, 5, 'V', 1, 0, 'C');
    $pdf->Cell(9, 5, '', 1, 0, 'C');
...
$pdf->Cell(40, 5, 'BLOK RECEIVER', 1, 0, 'L');
$pdf->Cell(55, 5, 'GEMATRONIK', 1, 0, 'C');
if ($kondisi[6] == 0) {
    $pdf->Cell(9, 5, 'V', 1, 0, 'C');
    $pdf->Cell(9, 5, '', 1, 0, 'C');
...
$pdf->Cell(40, 5, 'BLOK KABINET TRANSMITTER', 1, 0, 'L');
$pdf->Cell(55, 5, 'GEMATRONIK', 1, 0, 'C');
if ($kondisi[7] == 0) {
    $pdf->Cell(9, 5, 'V', 1, 0, 'C');
    $pdf->Cell(9, 5, '', 1, 0, 'C');
...
$pdf->Cell(40, 5, 'OBSTRUCTION LIGHTS', 1, 0, 'L');
$pdf->Cell(55, 5, '-', 1, 0, 'C');
if ($kondisi[8] == 0) {
    $pdf->Cell(9, 5, 'V', 1, 0, 'C');
    $pdf->Cell(9, 5, '', 1, 0, 'C');
...
$pdf->Cell(40, 5, 'UPS RADAR', 1, 0, 'L');
$pdf->Cell(55, 5, 'APC', 1, 0, 'C');
if ($kondisi[9] == 0) {
    $pdf->Cell(9, 5, 'V', 1, 0, 'C');
    $pdf->Cell(9, 5, '', 1, 0, 'C');
    $pdf->Cell(9, 5, '', 1, 0, 'C');
...
$pdf->Cell(40, 5, 'GENSET RADAR', 1, 0, 'L');
$pdf->Cell(55, 5, 'DEUTZ', 1, 0, 'C');
if ($kondisi[10] == 0) {
    $pdf->Cell(9, 5, 'V', 1, 0, 'C');
    $pdf->Cell(9, 5, '', 1, 0, 'C');
    $pdf->Cell(9, 5, '', 1, 0, 'C');
...
$pdf->Cell(40, 5, 'PC server', 1, 0, 'L');
$pdf->Cell(55, 5, 'DELL', 1, 0, 'C');
if ($kondisi[11] == 0) {
    $pdf->Cell(9, 5, 'V', 1, 0, 'C');
    $pdf->Cell(9, 5, '', 1, 0, 'C');
    $pdf->Cell(9, 5, '', 1, 0, 'C');
...
$pdf->Cell(40, 5, 'CLIENT FCT 1', 1, 0, 'L');
$pdf->Cell(55, 5, 'DELL', 1, 0, 'C');
if ($kondisi[12] == 0) {
    $pdf->Cell(9, 5, 'V', 1, 0, 'C');
    $pdf->Cell(9, 5, '', 1, 0, 'C');
...
$pdf->Cell(40, 5, 'CLIENT FCT 2', 1, 0, 'L');
$pdf->Cell(55, 5, 'LENOVO', 1, 0, 'C');
if ($kondisi[13] == 0) {
    $pdf->Cell(9, 5, 'V', 1, 0, 'C');
    $pdf->Cell(9, 5, '', 1, 0, 'C');
    $pdf->Cell(9, 5, '', 1, 0, 'C');
...
$pdf->Cell(40, 5, 'CLIENT APP', 1, 0, 'L');
$pdf->Cell(55, 5, 'LENOVO', 1, 0, 'C');
if ($kondisi[14] == 0) {
    $pdf->Cell(9, 5, 'V', 1, 0, 'C');
    $pdf->Cell(9, 5, '', 1, 0, 'C');
...
$pdf->Cell(40, 5, 'CLIENT OBS', 1, 0, 'L');
$pdf->Cell(55, 5, 'LONOVO', 1, 0, 'C');
if ($kondisi[15] == 0) {
    $pdf->Cell(9, 5, 'V', 1, 0, 'C');
    $pdf->Cell(9, 5, '', 1, 0, 'C');
    $pdf->Cell(9, 5, '', 1, 0, 'C');
