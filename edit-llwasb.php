...
if (isset($_GET['tanggal'])) {
    $sqlEdit = mysqli_query($connect, "select * from llwasb where Tanggal='$_GET[tanggal]'");
    $i = 0;
...
<head>
  <title>Form Pemeliharaan LLWAS Bulanan</title>
...
?><script>
 ...
 <form action="data-pemeliharaan.php" method="post">
        ...
        <tbody>
        <?php
$namaperalatan = array('Site sA2','Site sA3','Site sA4','Site sA5','Site sA6','Site sB2','Site sB3','Site sB4','Site sB5','Site sB6','Server ims0','Server ims1','PC Client Observer','PC Client Forecaster','PC Client Teknisi','PC Client ATC','PC Client APP');
$merksn = array('Microstep','Microstep','Microstep','Microstep','Microstep','Microstep','Microstep','Microstep','Microstep','Microstep','Fujitsu','Fujitsu','Fujitsu','Fujitsu','Fujitsu','Fujitsu','Fujitsu');
...
?>
      ...
      <div class="form-group"><label for="ti">Catatan Khusus : </label><textarea
          ...
          <input type="hidden" name="namaalat" value="llwasb">
