...
if (isset($_GET['tanggal'])) {
    $sqlEdit = mysqli_query($connect, "select * from alatdi where Tanggal='$_GET[tanggal]'");
    $i = 0;
...
<head>
  <title>Form Pemeliharaan DI</title>
...
<form action="data-pemeliharaan.php" method="post">
        ...
        <tbody>
        <?php
$namaperalatan = array('PC KASI DATIN','PC STAF DATIN','PC STAF DATIN','PC STAF DATIN','PC STAF DATIN','PC STAF DATIN','PC BULETIN','PC PELAYANAN','HUB 8 PORT','UPS 3 KVA','UPS 1 KVA','PLOTTER','MESIN FINGERPRINT','ROUTER','PRINTER');
$merksn = array('SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK','SEDERHANA ELEKTRONIK');
...
?>
            ...
            <input type="hidden" name="namaalat" value="alatdi">
